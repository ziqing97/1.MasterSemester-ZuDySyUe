...
% Ausgleichung
x1_hat = (A' * P * A) \ A' * P * y1;
epsilon_1 = y1 - A * x1_hat;
sigma01 = sqrt(epsilon_1' * P * epsilon_1 / r1); 
Sigma_x1 = sigma01^2 * inv(A'* P * A);
...
d_x_hat = (A' * P * A + A' * P * A) \ A' * P * (y2 - A * x1_hat);

sigma02 = sqrt((sigma01^2 * (r1 + d_x_hat' * inv(Sigma_x1) * d_x_hat) + (y2 - A * x2_hat)' * P * (y2 - A * x2_hat)) / r2);
